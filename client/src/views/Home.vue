...
// 壁纸设置
const wallpaperSource = ref('custom') // daily | random | custom
...
const randomWallpapers = [
    ...
    'https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=3000&q=80',
    'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?ixlib=rb-4.0.3&auto=format&fit=crop&w=3000&q=80',
    'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?ixlib=rb-4.0.3&auto=format&fit=crop&w=3000&q=80',
    'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixlib=rb-4.0.3&auto=format&fit=crop&w=3000&q=80',
    'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?ixlib=rb-4.0.3&auto=format&fit=crop&w=3000&q=80',
]

const changeWallpaper = (type) => {
    if (type === 'daily') {
        currentWallpaper.value = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=3000&q=80'
    } else if (type === 'random') {
        let nextIndex = Math.floor(Math.random() * randomWallpapers.length)
        let nextPaper = randomWallpapers[nextIndex]
        while (nextPaper === currentWallpaper.value && randomWallpapers.length > 1) {
            nextIndex = Math.floor(Math.random() * randomWallpapers.length)
            nextPaper = randomWallpapers[nextIndex]
        }
        currentWallpaper.value = nextPaper
    } else {
        currentWallpaper.value = 'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2940&q=80'
    }
}
...
const shortcutLinks = [
    ...
    },
    {
        ...
        paths: [
            { d: 'M761.759375 122h132.320625L605 452.4003125 945.08 902H678.8L470.24 629.3196875 231.599375 902H99.2l309.1996875-353.4L82.16 122h273.0403125l188.52 249.24z m-46.4390625 700.8h73.32L315.359375 197.0403125h-78.680625z', fill: 'currentColor' }
        ]
    },
    {
        name: 'YouTube',
    ...
    },
    {
        ...
        viewBox: '0 0 1024 1024',
        paths: [
            { d: 'M1020.416 301.568a373.76 373.76 0 0 0-24.064-124.416 240.128 240.128 0 0 0-58.368-91.136A250.368 250.368 0 0 0 847.36 27.648a374.784 374.784 0 0 0-123.904-24.064C668.672 0 651.264 0 512 0 373.76 0 358.4 0 301.568 3.072a373.76 373.76 0 0 0-123.904 24.064 249.344 249.344 0 0 0-91.136 58.88A250.368 250.368 0 0 0 27.648 176.64a374.784 374.784 0 0 0-24.064 123.904C0 355.84 0 373.248 0 512s0 156.672 3.072 210.944a373.76 373.76 0 0 0 24.064 124.416 249.856 249.856 0 0 0 59.392 90.624 250.368 250.368 0 0 0 90.112 58.88 375.296 375.296 0 0 0 124.416 24.064C358.4 1024 373.248 1024 512 1024s156.672 0 210.944-3.072a373.76 373.76 0 0 0 124.416-24.064 262.656 262.656 0 0 0 149.504-149.504 374.784 374.784 0 0 0 24.064-124.416c0-54.784 3.072-72.192 3.072-210.944s0-153.6-3.584-210.432zM929.28 716.8a280.576 280.576 0 0 1-17.408 95.232 158.208 158.208 0 0 1-38.4 58.368 160.768 160.768 0 0 1-58.88 38.4 282.112 282.112 0 0 1-95.232 17.408c-54.272 0-70.144 3.072-204.8 3.072s-153.6 0-204.8-3.072a280.576 280.576 0 0 1-95.232-17.408A158.208 158.208 0 0 1 153.6 870.4a160.768 160.768 0 0 1-38.4-58.88A281.6 281.6 0 0 1 96.256 716.8c0-54.272-3.072-70.144-3.072-204.8s0-153.6 3.072-204.8a280.576 280.576 0 0 1 17.408-97.28A158.72 158.72 0 0 1 153.6 153.6a160.256 160.256 0 0 1 57.344-40.96A282.112 282.112 0 0 1 307.2 95.232c53.76 0 70.144-3.072 204.8-3.072s153.6 0 204.8 3.072a280.064 280.064 0 0 1 95.232 17.408 158.208 158.208 0 0 1 58.88 38.4 160.768 160.768 0 0 1 38.4 58.88 282.112 282.112 0 0 1 19.968 97.28c0 54.272 3.072 70.144 3.072 204.8s-0.512 153.6-3.072 204.8z', fill: 'currentColor' },
            { d: 'M786.432 238.592m-61.44 0a61.44 61.44 0 1 0 122.88 0 61.44 61.44 0 1 0-122.88 0Z', fill: 'currentColor' },
            { d: 'M512 248.832A263.168 263.168 0 1 0 776.192 512 263.168 263.168 0 0 0 512 248.832z m0 433.664A170.496 170.496 0 1 1 683.52 512 170.496 170.496 0 0 1 512 682.496z', fill: 'currentColor' }
        ]
    },
    {
        name: 'Spotify',
    ...
    },
    {
        ...
        viewBox: '0 0 1024 1024',
        paths: [
            { d: 'M62 401.8V167.73c0-44.02 35.69-79.71 79.71-79.71h234.07c44.02 0 79.71 35.69 79.71 79.71V401.8c0 44.02-35.69 79.71-79.71 79.71H141.71C97.69 481.52 62 445.83 62 401.8z', fill: '#FF4F4F' },
            { d: 'M62 856.27V622.2c0-44.02 35.69-79.71 79.71-79.71h234.07c44.02 0 79.71 35.69 79.71 79.71v234.2c0 43.95-35.63 79.58-79.58 79.58h-234.2c-44.02 0-79.71-35.69-79.71-79.71z', fill: '#FFBC55' },
            { d: 'M509.02 401.8V167.73c0-44.02 35.69-79.71 79.71-79.71H822.8c44.02 0 79.71 35.69 79.71 79.71V401.8c0 44.02-35.69 79.71-79.71 79.71H588.73c-44.02 0.01-79.71-35.68-79.71-79.71z', fill: '#1AADF9' },
            { d: 'M705.77 542.48c-108.66 0-196.75 88.09-196.75 196.75s88.09 196.75 196.75 196.75c53.61 0 102.1-21.58 137.59-56.36l61.13 39.36a37.107 37.107 0 0 0 20.16 5.94c12.28 0 24.28-6.04 31.43-17.12 11.14-17.33 6.15-40.43-11.18-51.57l-59.11-38.06c10.64-24.2 16.75-50.82 16.75-78.95-0.02-108.65-88.11-196.74-196.77-196.74', fill: '#4381F1' }
        ]
    }
]
...
// 核心修改：使用 window.location.href 实现当前页跳转
const handleSearch = () => {
...
const updateTime = () => {
    ...
    if (showSeconds.value) {
        currentTime.value = `${hours.toString().padStart(2, '0')}:${minutes}:${seconds}`
    } else {
...
<template>
    <div class="home-container" :style="{ '--bg-blur': wallpaperBlur + 'px' }">
        ...
        <div class="bg-layer" :style="{ backgroundImage: `url(${currentWallpaper})` }">
                    ...
                    <div class="settings-group">
                        ...
                        <div class="setting-row">
                            ...
                            <div class="segmented-control">
                                ...
                                <div class="segment-item" :class="{ active: wallpaperSource === 'custom' }"
                                    @click="wallpaperSource = 'custom'">网站背景</div>
                            </div>
                        </div>
...
.bg-layer {
    ...
    inset: 0;
    z-index: 0;
    transition: filter 0.3s ease, background-image 0.5s ease-in-out;
